...
`Software Developer` · `Backend Systems` · `AI/LLM Applications`

*Building clean, scalable systems and experimenting with language models in practical applications.*

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/shantanuverma27/)
[![Gmail](https://img.shields.io/badge/Email-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:shantanuverma2709@gmail.com)
...
Databases   →   MongoDB  ·  SQLite  ·  FAISS  ·  Pinecone
AI / ML     →   LangChain  ·  RAG Pipelines  ·  Vector Search  ·  Gemini
```
...
> `FastAPI` `React 19` `LangChain` `Pinecone` `MongoDB` `Gemini 2.5`
